...
BOX_TOOL = {
    ...
    "examples": [
        ...
        {"cmd": f"box_slang_i18n --project-root ./app --config slang_i18n.yaml init", "desc": "在指定项目根目录下初始化"},
    ],
    "dependencies": [
        "PyYAML>=6.0",
        "openai>=1.0.0",
